...
export default function WithDraw() {
  ...
  const handleSubmit = async (data: z.infer<typeof formSchema>) => {
    const toastId = toast.loading("money withdrawing....");
    ...
    try {
      ...
      if (res.success) {
        toast.success("money withDraw successful", { id: toastId });
        form.reset();
      } else {
    ...
    <div className="w-full max-w-3xl mx-auto px-5 mt-16">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Withdraw money frm your wallet</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form
              id="add-withDraw-form"
              className="space-y-5"
        ...
        <CardFooter className="flex justify-end">
          <Button type="submit" form="add-withDraw-form">
            Withdraw Money
          </Button>
        </CardFooter>
      </Card>
